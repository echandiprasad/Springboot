package com.chandi.springboot.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.chandi.springboot.repositories",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "com.chandi.springboot.model" });
